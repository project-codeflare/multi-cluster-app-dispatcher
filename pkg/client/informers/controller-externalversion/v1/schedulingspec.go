...
import (
	...
	"github.com/kubernetes-sigs/kube-batch/pkg/client/listers/controller/v1"
)
...
func (f *schedulingSpecInformer) defaultSchedulingSpecInformer(client *rest.RESTClient, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *schedulingSpecInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&arbv1.SchedulingSpec{}, f.defaultSchedulingSpecInformer)
}
