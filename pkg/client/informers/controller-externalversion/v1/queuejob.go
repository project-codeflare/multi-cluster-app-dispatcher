...
func (f *queueJobInformer) defaultQueueJobInformer(client *rest.RESTClient, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *queueJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&arbv1.QueueJob{}, f.defaultQueueJobInformer)
}
