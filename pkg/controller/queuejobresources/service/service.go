...
func (qjrService *QueueJobResService) GetAggregatedResources(job *arbv1.XQueueJob) *clusterstateapi.Resource {
...
func (qjrService *QueueJobResService) GetAggregatedResourcesByPriority(priority int, job *arbv1.XQueueJob) *clusterstateapi.Resource {
