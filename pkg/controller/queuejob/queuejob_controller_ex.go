...
func (qjm *XController) GetAllObjectsOwned(caw *arbv1.AppWrapper) {
	...
	if countCompletedItems == countCompletionRequired && countCompletedItems != 0 && countCompletedItems == (len(caw.Spec.AggrResources.GenericItems)-ignoredItems) {
		caw.Status.State = arbv1.AppWrapperStateCompleted
		...
		caw.Status.State = arbv1.AppWrapperStateRunningHoldCompletion
	}
}
